...
const VentaFinal = () => {
  ...
  return (
    <div className='factura'>
      ...
      <p className='dataFinalTotal'>Total a pagar: ${total.toFixed(2)}</p>   {/* ojo! "toFixed"" redondea decimales pero devuelve un string! */}
      ...
      <Button count={count} subTotal={total} image={imageDetail} title={title} className='botonComprarEntrada2' />
    </div>
  );
};
