...
const Success = () => {
  return (
    <div className='contenedorSuccess'>
      ...
      <p className='textoSuccess'> <i className="bi bi-diamond-fill diamont"></i> En breve recibirás un correo electrónico, <br /> donde tendrás los detalles de tu compra y el acceso a tus E-tickets.</p>
      ...
      <p className='textoSuccess'> <i className="bi bi-diamond-fill diamont"></i> Puedes presentar el QR directamente desde tu celular el día del evento, <br /> si prefieres, también puedes imprimirlo.</p>
